import svgPaths from "./svg-pw7y6zzb6x";
...
function Frame4() {
  return (
    <div className="bg-white content-stretch flex gap-[4px] items-center justify-center overflow-clip px-[8px] py-[6px] relative shrink-0">
      <p className="font-['Geist_Mono:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[#160d22] text-[12px] text-nowrap whitespace-pre">Latest</p>
...
function Frame49() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Geist_Mono:Regular',sans-serif] font-normal leading-[1.1] opacity-70 relative shrink-0 text-[#160d22] text-[12px] text-nowrap whitespace-pre">Sort By:</p>
      <Frame4 />
    </div>
  );
}
