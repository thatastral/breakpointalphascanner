import svgPaths from "./svg-jycg5izqyu";
...
function Frame61() {
  return (
    <div className="content-stretch flex h-[24px] items-center relative shrink-0">
      <p className="font-['Geist_Mono:Regular',sans-serif] font-normal leading-[1.2] relative shrink-0 text-[14px] text-[rgba(17,17,17,0.8)] text-nowrap whitespace-pre">Latest</p>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex h-[24px] items-center relative shrink-0">
      <p className="font-['Geist_Mono:Regular',sans-serif] font-normal leading-[1.2] relative shrink-0 text-[14px] text-[rgba(17,17,17,0.8)] text-nowrap whitespace-pre">Most voted</p>
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="absolute bg-white left-[calc(50%+45.5px)] top-[135px] w-[135px]">
        ...
        <div className="h-0 relative shrink-0 w-full">
          <div className="absolute bottom-0 left-0 right-0 top-[-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 111 1">
              <line id="Line 1" stroke="var(--stroke-0, #160D22)" strokeOpacity="0.16" strokeWidth="0.5" x2="111" y1="0.25" y2="0.25" />
            </svg>
          </div>
        </div>
        <Frame62 />
      </div>
      <div aria-hidden="true" className="absolute border-[#160d22] border-[0.5px] border-solid inset-[-0.5px] pointer-events-none" />
    </div>
  );
}
...
export default function IPhone() {
  return (
    <div className="bg-white relative size-full" data-name="iPhone 16 - 11">
      <Frame45 />
      <Frame60 />
      <Frame48 />
      <Frame63 />
