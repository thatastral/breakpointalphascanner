import svgPaths from "./svg-qwe4kaq6s8";
...
function Frame27() {
  return (
    <div className="bg-[#ac66fd] relative shrink-0 w-full">
...
function Frame19() {
  return (
    <div className="absolute bg-[#160d22] bottom-[36px] content-stretch flex flex-col gap-[32px] items-center left-[16px] overflow-clip pb-[24px] pt-[48px] px-[24px] w-[361px]">
      <Frame26 />
      <Frame28 />
    </div>
  );
...
export default function IPhone() {
  return (
    <div className="bg-white relative size-full" data-name="iPhone 16 - 5">
      <Frame18 />
      <Frame25 />
      <div className="absolute backdrop-blur-sm backdrop-filter bg-[rgba(255,255,255,0.5)] h-[865px] left-[calc(50%+0.5px)] top-[calc(50%+0.5px)] translate-x-[-50%] translate-y-[-50%] w-[400px]" />
      <Frame19 />
    </div>
  );
}